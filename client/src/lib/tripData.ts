...
export const INDIAN_DESTINATIONS: Destination[] = [
  {
    name: "Jaipur", region: "Rajasthan", location: { lat: 26.9124, lng: 75.7873 }, image: "https://raw.githubusercontent.com/Keshav-xb/TripsForge/3307af91cdc5a51ff45fabc25f69aaf07b6e3942/destination-assets/jaipur.jpg", price: 11900, bestTime: "Oct — Mar", category: "Culture & food", mapLabel: "Pink City circuit", themes: ["History", "Food", "Architecture", "Shopping", "Photography", "Culture"], description: "Courtyards, craft studios and desert light woven into one deliberate route.",
    activities: [
  ...
  {
    name: "Goa", region: "Goa", location: { lat: 15.4909, lng: 73.8278 }, image: "https://raw.githubusercontent.com/Keshav-xb/TripsForge/3307af91cdc5a51ff45fabc25f69aaf07b6e3942/destination-assets/goa.jpg", price: 14800, bestTime: "Nov — Feb", category: "Beaches & slow days", mapLabel: "Coastal loop", themes: ["Beaches", "Food", "Nature", "Nightlife", "Photography"], description: "Salt air, quiet coves and a generous pace from one shoreline to the next.",
    activities: [
  ...
  {
    name: "Manali", region: "Himachal Pradesh", location: { lat: 32.2396, lng: 77.1887 }, image: "https://raw.githubusercontent.com/Keshav-xb/TripsForge/3307af91cdc5a51ff45fabc25f69aaf07b6e3942/destination-assets/manali.jpg", price: 13600, bestTime: "Mar — Jun", category: "Mountain adventure", mapLabel: "Kullu valley traverse", themes: ["Nature", "Adventure", "Photography", "Family", "Food"], description: "Cedar trails, glacial rivers and a mountain-day rhythm with room to breathe.",
    activities: [
  ...
  {
    name: "Kerala", region: "Kerala", location: { lat: 9.4981, lng: 76.3388 }, image: "https://raw.githubusercontent.com/Keshav-xb/TripsForge/3307af91cdc5a51ff45fabc25f69aaf07b6e3942/destination-assets/kerala.jpg", price: 15400, bestTime: "Sep — Mar", category: "Nature & wellness", mapLabel: "Backwater passage", themes: ["Nature", "Food", "Culture", "Family", "Photography"], description: "Backwater mornings, spice-rich kitchens and unhurried village channels.",
    activities: [
  ...
  { name: "Udaipur", region: "Rajasthan", location: { lat: 24.5854, lng: 73.7125 }, image: "https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=1000&q=85", price: 12700, bestTime: "Oct — Mar", category: "Romantic lakes", mapLabel: "Lake city loop", themes: ["Architecture", "Culture", "Food", "Photography"], description: "Lakeside palaces and whitewashed alleys for a romantic, unhurried circuit.", activities: [] },
  { name: "Rishikesh", region: "Uttarakhand", location: { lat: 30.0869, lng: 78.2676 }, image: "https://images.unsplash.com/photo-1626621331169-5f34be280ed9?auto=format&fit=crop&w=1000&q=85", price: 9800, bestTime: "Sep — Nov", category: "Adventure & nature", mapLabel: "Ganga river line", themes: ["Adventure", "Nature", "Food", "Culture"], description: "River mornings, forest air and a pulse of adventure in every bend.", activities: [] },
  { name: "Srinagar", region: "Kashmir", location: { lat: 34.0837, lng: 74.7973 }, image: "https://raw.githubusercontent.com/Keshav-xb/TripsForge/3307af91cdc5a51ff45fabc25f69aaf07b6e3942/destination-assets/srinagar.jpg", price: 17600, bestTime: "Apr — Oct", category: "Lakes & mountains", mapLabel: "Dal Lake circuit", themes: ["Nature", "Photography", "Food", "Family"], description: "A gentle lakeside route through gardens, mountain views and old-city flavour.", activities: [] },
];
