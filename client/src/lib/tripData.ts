...
export const INDIAN_DESTINATIONS: Destination[] = [
  {
    name: "Jaipur", region: "Rajasthan", image: "https://raw.githubusercontent.com/Keshav-xb/TripsForge/main/destination-assets/jaipur.jpg", price: 11900, bestTime: "Oct — Mar", category: "Culture & food", mapLabel: "Pink City circuit", themes: ["History", "Food", "Architecture", "Shopping", "Photography", "Culture"], description: "Courtyards, craft studios and desert light woven into one deliberate route.",
    activities: [
  ...
  {
    name: "Goa", region: "Goa", image: "https://raw.githubusercontent.com/Keshav-xb/TripsForge/main/destination-assets/goa.jpg", price: 14800, bestTime: "Nov — Feb", category: "Beaches & slow days", mapLabel: "Coastal loop", themes: ["Beaches", "Food", "Nature", "Nightlife", "Photography"], description: "Salt air, quiet coves and a generous pace from one shoreline to the next.",
    activities: [
  ...
  {
    name: "Manali", region: "Himachal Pradesh", image: "https://raw.githubusercontent.com/Keshav-xb/TripsForge/main/destination-assets/manali.jpg", price: 13600, bestTime: "Mar — Jun", category: "Mountain adventure", mapLabel: "Kullu valley traverse", themes: ["Nature", "Adventure", "Photography", "Family", "Food"], description: "Cedar trails, glacial rivers and a mountain-day rhythm with room to breathe.",
    activities: [
  ...
  {
    name: "Kerala", region: "Kerala", image: "https://raw.githubusercontent.com/Keshav-xb/TripsForge/main/destination-assets/kerala.jpg", price: 15400, bestTime: "Sep — Mar", category: "Nature & wellness", mapLabel: "Backwater passage", themes: ["Nature", "Food", "Culture", "Family", "Photography"], description: "Backwater mornings, spice-rich kitchens and unhurried village channels.",
    activities: [
  ...
  { name: "Srinagar", region: "Kashmir", image: "https://raw.githubusercontent.com/Keshav-xb/TripsForge/main/destination-assets/srinagar.jpg", price: 17600, bestTime: "Apr — Oct", category: "Lakes & mountains", mapLabel: "Dal Lake circuit", themes: ["Nature", "Photography", "Food", "Family"], description: "A gentle lakeside route through gardens, mountain views and old-city flavour.", activities: [] },
];
